...
class CallerServices extends SOAP_Client
{
	...
	#error_log("PROFILE=".print_r($profile,true));
	    ...
	    #error_log("SETTING CURLOPT_SSLCERT = " . $profile->getCertificateFile());
    ...
    function &getLogger()
    {
		...
		error_log("BAD LOGFILE: $file");
		$error = PayPal::raiseError("bad logfile: $file");
                return $error;
            }
