<div class="memberDesignerProfiles form">
<?php 
	echo $form->create('MemberDesignerProfile',array('type'=>'file','url'=>'/member_profiles/edit')); 
...
?>
	...
	<?= $javascript->event('MemberDesignerProfileAboutMe', 'keyup', ' textareaLimit(event, 200); '); ?>
	<?= $javascript->event('MemberDesignerProfileAboutMe', 'keydown', ' textareaLimit(event, 200); '); ?>
